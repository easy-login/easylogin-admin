# Generated by Django 2.2.17 on 2021-01-25 11:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oa1_secret', models.CharField(max_length=1023, null=True)),
                ('app', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loginapp.App')),
                ('social_profile', models.ForeignKey(db_column='social_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='loginapp.SocialProfile')),
            ],
            options={
